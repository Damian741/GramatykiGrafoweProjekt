...
def test3():
    ...
    graph_fragment = verticies_graph_fragment.get(5)
    graph_fragment.vertices.extend(list([Vertex(0.5, -1, 30, VertexLabel(1)), Vertex(0, -1.5, 31, VertexLabel(1)), Vertex(1, -1.5, 32, VertexLabel(1)), Vertex(0.5, -2, 33, VertexLabel(1))]))
    graph_fragment.edges.extend(list([(2, 30), (1, 31), (3, 31), (2, 32), (4,32), (3, 33), (4, 33)]))
    graph_fragment.edges.remove((1, 2))
    graph_fragment.edges.remove((1, 3))
    graph_fragment.edges.remove((4, 2))
    graph_fragment.edges.remove((3, 4))
...
def test4():
    ...
    P1(0)
    graph_fragment = verticies_graph_fragment.get(5)
    graph_fragment.vertices.extend(list([Vertex(0.5, -1, 30, VertexLabel(2)), Vertex(0, -1.5, 31, VertexLabel(1)), Vertex(1, -1.5, 32, VertexLabel(1)), Vertex(0.5, -2, 33, VertexLabel(1))]))
    graph_fragment.edges.extend(list([(1, 30), (2, 30), (1, 31), (3, 31), (2, 32), (4,32), (3, 33), (4, 33)]))
    graph_fragment.edges.remove((1, 2))
    graph_fragment.edges.remove((1, 3))
    graph_fragment.edges.remove((4, 2))
...
def test5():
    ...
    graph_fragment.vertices.extend(list([Vertex(0.5, -3, 70, VertexLabel(1)), Vertex(0, -3.5, 71, VertexLabel(1)), Vertex(1, -3.5, 72, VertexLabel(1)), Vertex(0.5, -4, 73, VertexLabel(1))]))
    graph_fragment.edges.extend(list([(6, 70), (7, 70), (6, 71), (8, 71), (7, 72), (9, 72), (8, 73), (9, 73)]))
    graph_fragment.edges.remove((6, 7))
    graph_fragment.edges.remove((8, 6))
    graph_fragment.edges.remove((7, 9))
    graph_fragment.edges.remove((9, 8))
    P6(10)
